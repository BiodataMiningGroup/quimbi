...
void main() {
	...
	vec3 color_r = texture2D(u_color_map_r, vec2(intensities.r, 0.5)).rgb;
/*
...
*/
    ...
    vec3 mixed_color = (intensities.r * color_r ) /
		float(dot(intensities.rgb, u_color_mask));
	...
	*/
	...
	gl_FragColor = vec4(color_r, intensities.a);
}